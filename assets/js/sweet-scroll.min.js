...
! function(t, n) {
	...
	function v(t, n) {
		for (var e = (t.document || t.ownerDocument)
			.querySelectorAll(n), i = e.length; --i >= 0 && e.item(i) !== t;);
		return i > -1
	}
				...
				value: function(t, n) {
					...
					if (!l && e(t))
						if ("#" === t) l = {
							...
							if (!a) return;
							l = a
						} return l ? (r && (l.top += r.top, l.left += r.left), o && (l.top = vt(0, l.top - w(o)
						.height)), l) : null
				}
			}, {
